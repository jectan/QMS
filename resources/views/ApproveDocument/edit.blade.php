...
@section('header')
    <h1 class="text-3xl font-bold tracking-tight text-gray-900">Approve Document</h1>
@endsection
...
<div class="card mt-5">
    ...
    <div class="d-grid gap-2 d-md-flex justify-content-md-end">
            <a class="btn btn-primary btn-danger" href="{{ route('Approve.index') }}"><i class="fa fa-arrow-left"></i> Back</a>
        </div>

        <form action="{{ route('Approve.update', $Approve->approveID) }}" method="POST">
            @csrf
            @method('PUT')
            <div class="mb-3">
            ...
            <div class="mb-3">
                <label for="inputName" class="form-label"><strong>Recommendation Date:</strong></label>
                <input 
                    type="date" 
                    name="reviewDate" 
                    class="form-control @error('name') is-invalid @enderror" 
