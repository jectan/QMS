...
@section('header')
    <h1 class="text-3xl font-bold tracking-tight text-gray-900">Add Document</h1>
@endsection
...
<div class="card mt-5">
    ...
    <div class="d-grid gap-2 d-md-flex justify-content-md-end">
            <a class="btn btn-primary btn-danger" href="{{ route('Document.index') }}"><i class="fa fa-arrow-left"></i> Back</a>
        </div>
        ...
        <form action="{{ route('Document.store') }}" method="POST">
            ...
            <div class="mb-3">
                <label for="inputName" class="form-label"><strong>Document Name:</strong></label>
                <input 
                    type="text" 
                    name="DocumentName" 
